...
namespace FSMS.Service.Validations.CropVarietyGrowthTask
{
    public class CropVarietyGrowthTaskValidator : AbstractValidator<CreateCropVarietyGrowthTask>
    {

        public CropVarietyGrowthTaskValidator()
        {
            RuleFor(o => o.TaskName)
            ...
            RuleFor(o => o.CropVarietyStageId)
                .NotEmpty().WithMessage("{PropertyName} is empty");
