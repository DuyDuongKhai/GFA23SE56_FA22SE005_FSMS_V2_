...
namespace FSMS.Service.Validations.FruitSupplier
{
    public class FruitSupplierValidator : AbstractValidator<CreateFruitSupplier>
    {
        public FruitSupplierValidator()
        {
            ...
            RuleFor(o => o.ProductDescription)
                .Cascade(CascadeMode.StopOnFirstFailure)
                .NotEmpty().WithMessage("{PropertyName} is empty")
